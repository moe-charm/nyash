...
**Minimal runtime kernel for Hako language - Plugin-First Architecture**
...
The Hako Kernel (`hako_kernel`, legacy `nyash_kernel`) is the minimal runtime core that replaced the legacy NyRT system. This represents a **42% reduction** in runtime complexity by moving from VM-dependent architecture to a unified Plugin-First system.
...
```
Target: libhako_kernel.a (static library)
...
The Hako Kernel integrates seamlessly with:
- **LLVM Backend**: Static linking via libhako_kernel.a
- **VM Backend**: Dynamic plugin loading
- **Build System**: tools/build_llvm.sh integration complete

---

*Part of Phase 15 Hako Self-hosting Revolution*
