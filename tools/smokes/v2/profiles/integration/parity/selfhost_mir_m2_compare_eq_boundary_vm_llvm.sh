#!/bin/bash
# selfhost_mir_m2_compare_eq_boundary_vm_llvm.sh — parity for compare ops at equality boundary (a=b)
...
TMP_DIR="/tmp/selfhost_mir_m2_compare_eq_boundary_vm_llvm_$$"
mkdir -p "$TMP_DIR"
...
EOF
  ...
  test_name="selfhost_mir_m2_compare_eq_${op}_vm_llvm"
