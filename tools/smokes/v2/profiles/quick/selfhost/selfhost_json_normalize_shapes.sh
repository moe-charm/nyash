#!/bin/bash
# selfhost_json_normalize_shapes.sh — Ensure JsonProgramBox normalizes If/Loop/Call/Return shapes.
...
static box Main {
  main() {
    local ast = "{\"version\":0,\"kind\":\"Program\",\"body\":[{\"type\":\"If\",\"then\":[{\"type\":\"Local\",\"expr\":{\"type\":\"Int\",\"value\":10},\"name\":\"value\"}],\"cond\":{\"type\":\"Compare\",\"lhs\":{\"type\":\"Int\",\"value\":1},\"op\":\"==\",\"rhs\":{\"type\":\"Int\",\"value\":1}},\"else\":[{\"type\":\"Local\",\"expr\":{\"type\":\"Int\",\"value\":5},\"name\":\"value\"}]},{\"type\":\"Loop\",\"cond\":{\"type\":\"Compare\",\"lhs\":{\"type\":\"Var\",\"name\":\"value\"},\"op\":\">\",\"rhs\":{\"type\":\"Int\",\"value\":0}},\"body\":[{\"type\":\"Expr\",\"expr\":{\"type\":\"Call\",\"name\":\"print\",\"args\":[{\"type\":\"Var\",\"name\":\"value\"}]}}]},{\"type\":\"Return\",\"expr\":{\"type\":\"Var\",\"name\":\"value\"}}]}"
