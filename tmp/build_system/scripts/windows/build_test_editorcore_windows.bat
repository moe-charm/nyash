@echo off
echo === Test_EditorCore_v23_Integrated - Windows Build ===
echo.
echo Building EditorCore unit test...
echo.
...
if not exist build-test-editorcore-windows mkdir build-test-editorcore-windows
cd build-test-editorcore-windows

:: Copy CMakeLists file
echo Preparing CMakeLists.txt...
copy /Y ..\CMakeLists_Test_EditorCore.txt CMakeLists.txt >nul

:: CMake configuration
echo Configuring CMake for EditorCore test...
...
:: Build
echo Building Test_EditorCore_v23_Integrated...
...
:: Check executable
if not exist "Test_EditorCore_v23_Integrated.exe" (
...
copy /Y "Test_EditorCore_v23_Integrated.exe" "..\windows_exe\"
...
copy /Y "Test_EditorCore_v23_Integrated.exe" "..\test_exe\"

:: Success message
echo.
echo === BUILD SUCCESS ===
echo Test_EditorCore_v23_Integrated.exe created successfully!
echo.
echo Primary Location: windows_exe\Test_EditorCore_v23_Integrated.exe
echo Backup Location: test_exe\Test_EditorCore_v23_Integrated.exe
echo.
echo Run the test to verify:
echo - EditorCore initialization
echo - Buffer creation and management
echo - Content editing and saving
