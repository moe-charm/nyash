@echo off
REM =============================================
REM NyaMesh v23 Windows Build Script
REM =============================================
REM 
REM Windows Build大作戦 - Automated Build
...
echo.
echo ================================================
echo NyaMesh v23 Windows Build大作戦
echo ================================================
echo Target: Windows 10/11 + Visual Studio 2022 + Qt6
echo Complexity Reduction: 82.7%% (EditorCore: 127→22)
...
:found_vs
echo ✓ Visual Studio 2022 found at %VS_2022_PATH%
...
if exist "Release\NyaMeshV23WindowsTest.exe" (
    echo ✓ Executable created: Release\NyaMeshV23WindowsTest.exe
) else (
    echo WARNING: Executable not found, checking bin directory...
    if exist "bin\NyaMeshV23WindowsTest.exe" (
        echo ✓ Executable created: bin\NyaMeshV23WindowsTest.exe
    ) else (
...
echo   ✓ Windows ANSI compatibility
echo   ✓ MSVC template deduction fixes
echo   ✓ 82.7%% complexity reduction
echo   ✓ Qt6 Windows integration
echo ================================================
echo.
...
echo.
echo Windows Build大作戦 Complete!
pause