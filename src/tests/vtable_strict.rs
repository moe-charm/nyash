...
fn vtable_map_set_and_strict_unknown() {
    ...
    f.get_block_mut(bb)
        .unwrap()
        .add_instruction(MirInstruction::Call { dst: None, func: crate::mir::ValueId::new(0), callee: Some(crate::mir::definitions::Callee::ModuleFunction("MapBox.set/2".into())), args: vec![mapv, k, v], effects: EffectMask::PURE });
    let sz = f.next_value_id();
    f.get_block_mut(bb)
        .unwrap()
        .add_instruction(MirInstruction::Call { dst: Some(sz), func: crate::mir::ValueId::new(0), callee: Some(crate::mir::definitions::Callee::ModuleFunction("MapBox.size/0".into())), args: vec![mapv], effects: EffectMask::PURE });
    f.get_block_mut(bb)
        .unwrap()
    ...
    f2.get_block_mut(bb2)
        .unwrap()
        .add_instruction(MirInstruction::Call { dst: None, func: crate::mir::ValueId::new(0), callee: Some(crate::mir::definitions::Callee::ModuleFunction("MapBox.unknown/0".into())), args: vec![m2], effects: EffectMask::PURE });
    f2.get_block_mut(bb2)
        .unwrap()
